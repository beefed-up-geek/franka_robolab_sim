...
ENVS: dict[str, EnvSpec] = {
    ...
    "task3_train": EnvSpec(
        ...
        conveyor="script",
        description="정상 통조림만 · 벨트 1.5 m/분 · 간격 0.14m (수집)",
        defaults={"grip_force": 25.0, "belt_speed": 1.5, "spacing": 0.14,
                  "defect_ratio": 0.0, "belt_jitter": 0.15},
    ),
    "task3_test": EnvSpec(
        task="Task3TestPickPlaceCanTask",
        world="CanSortingWorldCfg",
        conveyor="script",
        description="정상 4종 + 파열 4종 · 불량 20% (평가)",
        defaults={"grip_force": 25.0, "belt_speed": 1.5, "spacing": 0.14,
                  "defect_ratio": 0.2, "belt_jitter": 0.15},
    ),
}
